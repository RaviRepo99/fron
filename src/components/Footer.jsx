    ...
    <footer className="bg-gray-900 text-gray-300 mt-8 md:mt-12">
      <div className="container mx-auto px-3 md:px-4 py-6 md:py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-8">
          {/* About Section */}
          <div>
            <h3 className="text-white text-base md:text-lg font-bold mb-3 md:mb-4">About Madhesh Matters Live</h3>
            <p className="text-xs md:text-sm leading-relaxed">
              Madhesh Matter News Channel is an independent online news platform delivering the latest updates on politics, business, sports, entertainment, and international affairs. Our goal is to provide accurate, timely, and reliable news to keep readers informed about important events in Nepal and around the world.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-1.5 md:space-y-2 text-xs md:text-sm">
              <li>Janakpur Dham</li>
              <li>Madhesh Pradesh</li>
              <li>Kathmandu, Nepal</li>
              <li className="pt-1 md:pt-2">
                <a href="mailto:mattermadhesh@gmail.com" className="hover:text-red-500 transition-colors">
                  mattermadhesh@gmail.com
                </a>
              </li>
              <li className="pt-1 md:pt-2">
                <a 
                  href="tel:+9779849745645" 
        ...
        <div className="border-t border-gray-700 mt-6 md:mt-8 pt-6 md:pt-8">
          <div className="flex flex-col items-center justify-center text-center space-y-3 md:space-y-4">
            {/* GitHub Icon */}
            <a 
              href="https://github.com/miteshparadox" 
              target="_blank" 
            ...
            <div className="flex flex-wrap items-center justify-center gap-3 md:gap-6 text-xs md:text-sm">
              <p>© {new Date().getFullYear()} Madhesh Matters. All rights reserved.</p>
              <span>Made by <a href="https://www.instagram.com/mites.shh/" target="_blank" rel="noopener noreferrer" className="hover:text-red-500 transition-colors">Mitesh Mandal</a></span>
